...
import { Plus, Users, Mail, Phone, Droplet, Upload } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#29B86F] hover:bg-[#238f5a] text-white rounded-xl font-medium transition shadow-sm"
          >
            <Upload size={18} />
            Importar
          </Link>
          <Link
            href="/patients/new"
            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#0A6CBD] hover:bg-[#095a9d] text-white rounded-xl font-medium transition shadow-sm"
          >
            <Plus size={18} />
            Nuevo paciente
          </Link>
      ...
      <div className="flex items-center gap-4">
        ...
        />
        {patients.length !== initialPatients.length && (
